        ...
        {outerWidth < 992 ? (
          <>
            <div className="CompactMenuButton_Container">
              <ShoppingCart />
              <button className="btn btn-color-t" onClick={handlingCompactMenu}>
                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" className="bi bi-list" viewBox="0 0 16 16">
